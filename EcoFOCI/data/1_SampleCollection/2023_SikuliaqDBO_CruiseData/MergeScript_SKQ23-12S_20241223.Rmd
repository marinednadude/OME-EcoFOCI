...
# Re-Merge Brynn
```{r}
QAQCMRE_CruiseSampleMetadata_SKQ23_12S$Rosette_position <- as.character(QAQCMRE_CruiseSampleMetadata_SKQ23_12S$Rosette_position)

bottle_Data %>% 
  mutate(., btl_pressure = round(btl_PrDM, 0)) %>%
  left_join(ctd_Data, by = c("Cast" = "Cast", "btl_pressure" = "pressure")) -> ctd_btl_combined
