...
FinalOME_Merge_DY20_12 %>% 
  mutate(., pH = NA,
            pH_method = NA) %>%
  dplyr::select(Sample_Name, Biological_Replicate, Technical_Replicate, Negative_control, Cruise_ID_short, Cruise_ID_long, Cast_No.,Rosette_position, Station, Sample_volume_ml, Field_collection_method, Preservation, pH, pH_method,
                Time=ctd_time..UTC., 
...
#RCGOA2022_long
 #  carbonate chemistry not included since no other cruise has that data as of 12/26/2024 
  ...
  mutate(., pH_method= "SBE-18 pH sensor") %>% 
   dplyr::select(Sample_Name, Biological_Replicate, Technical_Replicate, Negative_control, Cruise_ID_short, Cruise_ID_long, Cast_No.,Rosette_position, Station, Sample_volume_ml, Field_collection_method, Preservation, pH_method,
                Time=ctd_time..UTC., 
