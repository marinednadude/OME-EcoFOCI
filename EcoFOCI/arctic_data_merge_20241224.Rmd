...
revamp_sample_metadata <- merge(
  ...
  y = extractions_df[, c("final_sample_name", "qubit_conc_ng.uL")],
  by.x = "Sample_Name",
...
revamp_sample_metadata %>%
 mutate(., Sample_Name = str_replace_all(Sample_Name,"_","\\.")) -> revamp_sample_metadata
...
run1_4_revamp_formatted_metadata <- full_join(
  ...
  distinct() # remove duplicated rows (e.g. PCR replicates)
